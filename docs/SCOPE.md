...
văn bản sửa đổi và hướng dẫn ingest nằm tại `LEGAL_SOURCES.md`.
...
- Không trả lời trong MVP về BHXH, BHYT, BHTN, công đoàn, an toàn vệ sinh lao
  ...
  rộng sau MVP, xem `LEGAL_SOURCES.md`.
...
- [ ] Bộ 30 câu hỏi eval có kết quả đo được trong `EVALUATION.md`.
